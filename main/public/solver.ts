...
class Board {
    ...
    private insertBlocks(): void {
        ...
        if (coveredCells !== 18) throw new Error("Deve haver pelo menos 2 espaços vazios no tabuleiro!");
        if (!fourBlock) throw new Error("A peça 2x2 vermelha deve estar no tabuleiro!");
    }
